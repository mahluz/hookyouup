...
class IndexModel extends CI_Model {
    ...
    public function sendEmail($to_email)
    {
        ...
        $message = 'Dear User,<br /><br />Please click on the below activation link to verify your email address.<br /><br /> http://localhost/hookyouup/Index/verify/' . md5($to_email) . '<br /><br /><br />Thanks<br /><b>Hook You Up Team Developer</b>';
